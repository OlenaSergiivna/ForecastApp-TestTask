...
class DemoForecastNetworkServiceImpl: ForecastNetworkService {
    func getForecast() -> AnyPublisher<[ForecastItemDTO], Error> {
        ...
        let demoData: [ForecastItemDTO] = [
            ...
            ForecastItemDTO(day: "2", description: "Overcast", sunrise: 17340, sunset: 76440, chanceRain: 0.2, high: 31, low: 22, type: "overcast"),
            ForecastItemDTO(day: "3", description: "Rain", sunrise: 17400, sunset: 76440, chanceRain: 0.6, high: 28, low: 19, type: "rain"),
            ...
            ForecastItemDTO(day: "6", description: "Overcast", sunrise: 17580, sunset: 76440, chanceRain: 0.0, high: 28, low: 19, type: "overcast"),
            ...
            ForecastItemDTO(day: "10", description: "Overcast", sunrise: 17820, sunset: 76440, chanceRain: 0.4, high: 28, low: 19, type: "overcast"),
            ForecastItemDTO(day: "11", description: "Rain", sunrise: 17880, sunset: 76440, chanceRain: 0.8, high: 26, low: 18, type: "rain"),
            ...
            ForecastItemDTO(day: "14", description: "Overcast", sunrise: 18060, sunset: 76440, chanceRain: 0.5, high: 27, low: 18, type: "overcast"),
